...
<div id="items_info">
	...
	<table class="cart_order" style="clear: both; border-collapse: collapse; border: 1px solid black;">
		<thead>
			<tr>
				<th style="text-align: left; width: 150px; border: 1px solid black;"><?php echo JText::_("K2STORE_CART_ITEM"); ?></th>
				<th style="width: 50px; text-align: center; border: 1px solid black;"><?php echo JText::_("K2STORE_CART_ITEM_QUANTITY"); ?>
				</th>
				<th style="width: 50px; text-align: center; border: 1px solid black;"><?php echo JText::_("K2STORE_ITEM_PRICE"); ?>
				</th>
				<th style="width: 50px; text-align: center; border: 1px solid black;"><?php echo JText::_( "K2STORE_CART_ITEM_UNIT_PRICE" ); ?></th>
			</tr>
		</thead>
		<tbody>
			<?php $i=0; $k=0; ?>
			...
			<tr class='row<?php echo $k; ?>'>
				...
				<?php echo JText::_( $item->orderitem_name ); ?> <br />
				<!-- start of orderitem attributes -->
					...
					<?php if (!empty($item->orderitem_sku)) : ?><b><?php echo JText::_( "K2STORE_SKU" ); ?>:</b><?php echo $item->orderitem_sku; ?>
						<br />
					<?php endif; ?>
				</td>
				<td style="text-align: center; border: 1px solid black;"><?php echo $item->orderitem_quantity; ?>
				</td>
				<td style="text-align: center; border: 1px solid black;"><?php echo K2StorePrices::number( $item->orderitem_price, $row->currency_code, $row->currency_value); ?>
				</td>
				<td style="text-align: center; border: 1px solid black;"><?php echo K2StorePrices::number( $item->orderitem_final_price, $row->currency_code, $row->currency_value ); ?>
				</td>
			</tr>
			<?php $i=$i+1; $k = (1 - $k); ?>
			<?php endforeach; ?>
		...
		<tfoot>
			<tr>
				<th colspan="2" style="text-align: right; border: 1px solid black;"><?php echo JText::_( "K2STORE_CART_SUBTOTAL" ); ?>
				</th>
				<th style="text-align: right;border: 1px solid black;"><?php echo K2StorePrices::number($order->order_subtotal, $row->currency_code, $row->currency_value); ?>
				</th>
			</tr>
