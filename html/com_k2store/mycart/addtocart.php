...
<form action="<?php echo $action; ?>" method="post" class="k2storeCartForm1" id="<?php echo $formName; ?>" name="<?php echo $formName; ?>" enctype="multipart/form-data">
   ...
   <?php if($this->params->get('show_sku_field', 0)):?>
	 		<div id='product_sku_<?php echo $item->product_id; ?>' class="product_sku" itemscope itemtype="http://schema.org/SKU">
				<span class="code"><?php echo JText::_( "K2STORE_SKU" ); ?>:</span>
				<span class="code_tour" property="sku"><?php echo $this->product->product_sku; ?></span>
     		</div>
	<?php endif;?>

	<?php if($this->params->get('show_price_field', 1)):?>
		<div class="price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
			<!--<span class="itemPriceLabel">Package Price:</span>-->
			<span class="itemPriceLabel"><?php echo JText::_( "K2_PACKAGE_PRICE" ); ?>:</span>
			<!--base price-->
			<span id="product_price_<?php echo $item->product_id; ?>" class="product_price" itemprop="price" content="<?php  echo K2StoreHelperCart::dispayPriceWithTax($item->price, $item->tax, $this->params->get('price_display_options', 1)); ?>">
			...
			<?php if($item->special_price > 0.000) :?>
				<span class="itemPriceLabel"><?php echo JText::_( "K2_SPECIAL_PRICE" ); ?>:</span>
			    <span id="product_special_price_<?php echo $item->product_id; ?>" class="product_special_price" itemprop="price">
		...
		<?php if($allow):?>
				   ...
				   <!--  trigger plugin events -->
					...
					<div class="k2_store_buttons">    
						...
						<!--<div class="ask_qus_wrapper">
							<a class="btn btn-primary" href="javascript:void(0);">Ask any question</a>
						</div>-->
					</div>
