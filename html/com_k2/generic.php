			  ...
			  <?php endif; ?>
			  	<aside class="article-aside clearfix">
				  	<?php if($this->params->get('genericItemCategory')): ?>
						<!-- Item category name -->
						<dd class="category-name" title="" data-original-title="<?php echo JText::_('K2_PUBLISHED_IN'); ?>">
					...
					<?php endif; ?>
				  	<?php if($this->params->get('genericItemDateCreated')): ?>
						...
						<time datetime="<?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_FORMAT_LC2')); ?>" itemprop="datePublished">
							<span class="genericItemDateCreated"><?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_FORMAT_LC2')); ?></span>
						</time>
						</dd>
					<?php endif; ?>
				</aside>
