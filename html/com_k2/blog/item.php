			  	...
			  	<dl class="article-info">
				  	<?php if($this->item->params->get('itemCategory')): ?>
						<dd class="category-name hasTooltip" title="" data-original-title="Category: ">
							...
							<a href="<?php echo $this->item->category->link; ?>"><span itemprop="genre"><?php echo $this->item->category->name; ?></span></a>
						</dd>
					<?php endif; ?>
					...
					<?php if($this->item->params->get('itemAuthor')): ?>
						<dd class="createdby" itemscope="" itemprop="author" itemtype="http://schema.org/Person" title="" data-original-title="Written by">
							<i class="fa fa-user"></i>
								<!--<?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?>&nbsp;-->
								<?php if(empty($this->item->created_by_alias)): ?>
								<a itemprop="url" href="<?php echo $this->item->author->link; ?>">
