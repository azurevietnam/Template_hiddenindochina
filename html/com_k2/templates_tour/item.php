...
<div id="k2Container" class="itemView_tour<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
			  	...
			  	<dl class="article-info">
				  	<?php if($this->item->params->get('itemCategory')): ?>
						<dd class="category-name hasTooltip" title="" data-original-title="Category: ">
							...
							<a href="<?php echo $this->item->category->link; ?>"><span><?php echo $this->item->category->name; ?></span></a>
						</dd>
					<?php endif; ?>
					<?php if($this->item->params->get('itemDateCreated')): ?>
						<dd class="published" title="" data-original-title="Published on ">
							<i class="fa fa-calendar"></i>
							<span class="itemDateCreated">
								<time datetime="<?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT')); ?>">
		...
		<?php endif; ?>
				...
				<div class="images_intro">
				  	...
				  	<!-- Item Image -->
						<div class="itemImageBlock">
							  <span class="itemImage_tour">
							  	<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
							  		<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" itemprop="image"/>
							  	</a>
							  </span>
			...
			<section class="article-content clearfix"  itemprop="description">
					<?php if(!empty($this->item->fulltext)): ?>
						<?php if($this->item->params->get('itemFullText')): ?>
							<h2 class="tour_detail">
								<span><?php echo JText::_('K2_TOUR_DETAIL'); ?></span>
							</h2>
							<!-- Item fulltext -->
			...
			<div class="promotion">
						...
						<div class="rating-view">
							...
							<!-- Item Rating -->
								<span class="itemRating"><?php echo JText::_('K2_RATE_THIS_ITEM'); ?></span>
								<div class="itemRatingForm">
									...
									<div id="itemRatingLog<?php echo $this->item->id; ?>" class="itemRatingLog" itemprop="ratingValue"><?php echo $this->item->numOfvotes; ?></div>
									<div class="clr"></div>
								</div>
							<?php endif; ?>
							<?php if($this->item->params->get('itemHits')): ?>
								<dd class="hits">
									<i class="fa fa-eye"></i>
									<!-- Item Hits -->
									<span itemprop="ratingCount"><b><?php echo $this->item->hits; ?></b></span>
								</dd>
							<?php endif; ?>
							</div>
						</div>
			...
			<div class="itemToolbar">
					...
					<li>
						<a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
							<span><i class="fa fa-paper-plane"></i><?php echo JText::_('K2_EMAIL'); ?></span>
						</a>
					</li>
					<?php endif; ?>
					...
					<li>
						<a class="itemImageGalleryLink k2Anchor" href="<?php echo $this->item->link; ?>#itemImageGalleryAnchor"><span><i class="fa fa-file-image-o"></i><?php echo JText::_('K2_IMAGE_GALLERY'); ?></span></a>
					</li>
					<?php endif; ?>
					</ul>
					<div class="clr"></div>
		...
		*/
		...
		<?php if($this->item->params->get('itemRelated') && isset($this->relatedItems)): ?>
	  	<!-- Related items by tag -->
			...
			<h3><?php echo JText::_("K2_RELATED_TOUR_BY_TAG"); ?></h3>
				<?php foreach($this->relatedItems as $key=>$item): ?>
				<div class="<?php echo ($key%2) ? "tour-odd" : "tour-even"; ?>">
					...
					<?php if($this->item->params->get('catItemExtraFields') && count($this->item->extra_fields)): ?>
				  	<!-- Item extra fields -->
				  	<div class="catItemExtraFields" itemprop="description">
		...
		<?php endif; ?>
			...
			<div class="col-md-3 col-sm-12">
				<div class="sidebar">
					<div id="text-8">
						<div class="widgets tour-package">
							<!-- Item extra fields -->
							<h3><?php echo JText::_('K2_ADDITIONAL_INFO'); ?></h3>
							<?php if($this->item->params->get('itemExtraFields') && count($this->item->extra_fields)): ?>
									  <div class="itemExtraFields" itemprop="description">
									  	<ul>
											<?php foreach ($this->item->extra_fields as $key=>$extraField): ?>
											<?php if($extraField->value != ''): ?>
					...
					<div id="text-7">
						<div class="widgets phone-support">
						<h3>Tư vấn điện thoại</h3>
						<span class="call-app">
						<span>Hotline</span>
						   <a href="tel:+84838337345" class="phone-number">08.38.337.345</a>
						</span><br/>
						</div>
					</div>
				</div>
...
jQuery(document).ready(function(){
  var q2w3_sidebar_1_options = { "sidebar" : "accelerate_right_sidebar", "margin_top" : 0, "margin_bottom" : 725, "screen_max_width" : 0, "width_inherit" : false, "widgets" : ['text-8','text-7'] };
  q2w3_sidebar(q2w3_sidebar_1_options);
  setInterval(function () { q2w3_sidebar(q2w3_sidebar_1_options); }, 1500);
});
</script>
					<script type='text/javascript' src='<?php echo JURI::root(true); ?>/templates/indovillage/js/fixed-widget.min.js'></script>
			</div>
		</div>
