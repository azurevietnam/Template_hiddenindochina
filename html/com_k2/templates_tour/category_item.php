...
<article class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php echo $this->item->event->K2BeforeDisplay; ?>
  	...
  	<div class="catItemBody_tour">
	  	<section class="article-intro clearfix">
			<!-- Plugins: BeforeDisplayContent -->
			<?php echo $this->item->event->BeforeDisplayContent; ?>
			<!-- K2 Plugins: K2BeforeDisplayContent -->
			<?php echo $this->item->event->K2BeforeDisplayContent; ?>
			<div class="cat_tour row">
			<?php if($this->item->params->get('catItemImage') && !empty($this->item->image)): ?>
			<!-- Item Image -->
		  		<div class="cat_Image col-md-5 col-sm-12">
				  	<div class="catItemImageBlock">
					  	<span class="catItemImage">
					    	<a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
					    		<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" itemprop="image"/>
					    	</a>
					  	</span>
				  	</div>
				</div>
		  	<?php endif; ?>
		  	<div class="tour-package col-md-7 col-sm-12">
		  		<div class="catItemHeader">
						  ...
						  <!-- Item title -->
							<h2 class="catItemTitle">
									...
									<span class="catItemEditLink">
										<a class="modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->editLink; ?>" itemprop="url">
											<?php echo JText::_('K2_EDIT_ITEM'); ?>
										</a>
									</span>
									<?php endif; ?>
								  	<?php if ($this->item->params->get('catItemTitleLinked')): ?>
										<a itemprop="url" href="<?php echo $this->item->link; ?>">
					...
					<aside class="article-aside clearfix">
						...
						<!-- Item category name -->
						<dd class="category-name" title="" data-original-title="Category: ">
						...
						<dd class="published" title="" data-original-title="Published on ">
							...
							<time datetime="<?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT')); ?>" itemprop="datePublished">
						...
						<!-- Item Author -->
						<dd class="createdby" itemprop="author" itemscope="" itemtype="http://schema.org/Person" title="" data-original-title="Written by ">
						...
						<dd class="hits">
							<i class="fa fa-eye"></i>
							<meta itemprop="interactionCount" content="<b><?php echo $this->item->hits; ?></b> <?php echo JText::_('K2_TIMES'); ?>">
		  	...
		  	<div class="view-detail">
		  		<?php if ($this->item->params->get('catItemReadMore')): ?>
					<!-- Item "read more..." link -->
					<div class="catItemReadMore">
						<a class="k2view-detail" href="<?php echo $this->item->link; ?>">
							<?php echo JText::_('K2_VIEW_DETAIL'); ?>
						</a>
					</div>
				<?php endif; ?>
		  	</div>
