...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
    ...
    <div class="<?php echo ($key%2) ? "tour-odd" : "tour-even"; if(count($items)==$key+1) echo ' lastTour'; ?>" itemscope itemtype="http://schema.org/Product">
      ...
      <a class="moduleItemTitle" href="<?php echo $item->link; ?>"><span itemprop="name"><?php echo $item->title; ?></span></a>
      <?php endif; ?>
      ...
      <div class="moduleItemIntrotext Tour_Hot">
