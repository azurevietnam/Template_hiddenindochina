			...
			<ul>
				...
				<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
					...
					<div class="moduleItemIntrotext">
						...
						<h3 class="moduleItemTitle"><a href="<?php echo $item->link; ?>" title="<?php echo $item->title; ?>"><?php echo $item->title; ?></a></h3>
						<?php endif; ?>
						...
						<?php endif; ?>
							<a class="moduleItemReadMore" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;"><?php echo JText::_('K2_READ_MORE'); ?></a>
						</div>
					</div>
					<?php endif; ?>
					<div class="clr"></div>
...
<script type='text/javascript' src='<?php echo JURI::root(true); ?>/templates/indovillage/js/jquery.js'></script>
<script type='text/javascript' src='<?php echo JURI::root(true); ?>/templates/indovillage/js/jquery.jcarousel.min.js'></script>
