...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "Tour_odd" : "Tour_even"; if(count($items)==$key+1) echo ' Tour_lastItem'; ?>" itemscope itemtype="http://schema.org/Product">
			<div class="Tour_info">
				...
				<div class="moduleItemIntrotext">
					...
					<a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
						<img itemprop="image" src="<?php echo $item->image; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>"/>
					</a>
					<?php endif; ?>
				...
				<div class="tour-desc">
					...
					<a class="moduleItemTitle" href="<?php echo $item->link; ?>" itemprop="url"><span itemprop="name"><?php echo $item->title; ?></span></a>
					<?php endif; ?>
					<?php if($params->get('itemExtraFields') && count($item->extra_fields)): ?>
					<div class="moduleItemExtraFields" itemprop="description">
						<ul>
					...
					<a class="moduleItemCategory" href="<?php echo $item->categoryLink; ?>"><span><?php echo $item->categoryname; ?></span></a>
					<?php endif; ?>
				...
				<!--K2 READMORE-->
				<div class="readmore">
					<a class="moduleItemReadMore" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> - <?php echo K2HelperUtilities::cleanHtml($item->title); ?>">
