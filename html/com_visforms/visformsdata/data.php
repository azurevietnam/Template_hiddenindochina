...
?>
            ...
            { 
                ...
                {
                    echo JHTMLVisforms::sort( 'COM_VISFORMS_ID', 'a.id', $listDirn, $listOrder, 'visformsdata.display'); 
                }
                else
                {
                    echo " &nbsp; "; 
...
?>
			<th>
				<?php echo JHTMLVisforms::sort($rowField->label, 'a.F'. $rowField->id, $listDirn, $listOrder, 'visformsdata.display'); ?>
			</th>
<?php	
		}
	}
 ...
 ?>
		<th class="data-ip">
			<?php echo JHTMLVisforms::sort( 'COM_VISFORMS_IP', 'a.ipaddress', $listDirn, $listOrder, 'visformsdata.display'); ?>
		</th>
<?php
	} 
 ...
 ?>
		<th class="data-mfd">
			<?php echo JHTMLVisforms::sort( 'COM_VISFORMS_MODIFIED', 'a.ismfd', $listDirn, $listOrder, 'visformsdata.display'); ?>
		</th>
<?php
	} 
    ...
    {
 ?>
		<th class="data-created">
			<?php echo JHTMLVisforms::sort( 'COM_VISFORMS_SUBMISSIONDATE', 'a.created', $listDirn, $listOrder, 'visformsdata.display'); ?>
		</th>
<?php
	} 
?>
...
<?php 
	JPluginHelper::importPlugin('content');
    echo JHtml::_('content.prepare', $texte);
	?>
	</td> 
